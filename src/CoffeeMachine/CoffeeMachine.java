...
public class CoffeeMachine {
    ...
    public void getСheque (Coffee coffee, int howMach, double money, int sugar){
        System.out.println("++++++++++++++++++++++++++++++++");
        ...
        if (getChange(money, howMach, founded, sugar) == null){
            ...
            if (sugarPortion >= sugar) {
                if (founded != null) {
                    ...
                    getСheque(founded, howMach, money, sugar);
                    return founded;
                }
            }
            else {
    ...
    public Double getChange (double money, int howMach, Coffee coffee, double sugar){
        if (money >= coffee.getCoffeePrice() + sugar) {
            double change = money - coffee.getCoffeePrice() * howMach - sugar * sugarPrice;
            return change;
        }
        return null;
    }
